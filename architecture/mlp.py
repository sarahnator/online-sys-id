...
class MLP(torch.nn.Module):
    ...
    def forward(self, x: torch.Tensor, params: List[Tuple[torch.tensor, torch.tensor]]= None) -> torch.Tensor:
        """Forward pass through the MLP, with optional custom weights.
        ...
        # If params are provided, use them instead of the model's parameters
        else:
