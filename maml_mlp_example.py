...
model.load_state_dict(torch.load(f"./logs/VanDerPol_{alg}_MLP/model.pth", map_location=device))
...
# plt.show()
# save the figure
fig.savefig(f"./logs/VanDerPol_{alg}_MLP/qualitative_example.png", bbox_inches='tight')
...
plt.tight_layout()
# plt.show()
fig.savefig(f"./logs/VanDerPol_{alg}_MLP/losses.png", bbox_inches='tight')
...
}, f"./logs/VanDerPol_{alg}_MLP/losses.pth")