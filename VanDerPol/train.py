...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_example_points", type=int, default=200)
    parser.add_argument("--n_points", type=int, default=200)
    # parser.add_argument("--algorithm", type=str, default="FE_NODE")
    # parser.add_argument("--algorithm", type=str, default="MAML2_NODE")
    # parser.add_argument("--algorithm", type=str, default="MAML2_MLP")
    parser.add_argument("--algorithm", type=str, default="MAML_NODE")
    # parser.add_argument("--algorithm", type=str, default="NODE")
    # parser.add_argument("--algorithm", type=str, default="MLP")
