...
for test in tests:
    ...
    losses_meta_trained_maml_100_shot = torch.load(f"./logs/VanDerPol_MAML_NODE/losses_{test}.pth")["losses_maml"].cpu()
    ...
    ax.plot(losses_meta_trained_maml_100_shot, label="Meta-trained NODE + MAML (100-shot)", color='C6')
