...
from util.inner_products import standard_inner_product
...
class BasisFunctions(torch.nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """Evaluate all basis functions at the input points. This computes the regressor matrix.
...
class FunctionEncoder(BaseModel):
    ...
    def compute_coefficients(
        ...
        coefficients, G = self.coefficients_method(f, g, self.inner_product) # solve the least squares problem
